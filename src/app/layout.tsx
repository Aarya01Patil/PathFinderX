...
export const metadata: Metadata = {
  title: "PathFinder - Interactive Graph Algorithm Playground",
  ...
  openGraph: {
    title: "PathFinder - Interactive Graph Algorithm Playground",
    description: "Simulate A*, Dijkstra, BFS, and DFS with PathFinder's real-time graph playground. Build and share custom graphs!",
    url: "https://pathfinder-app.vercel.app",
    siteName: "PathFinder",
    images: [
      {
